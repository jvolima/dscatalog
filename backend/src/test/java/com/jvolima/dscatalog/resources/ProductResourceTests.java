...
import com.jvolima.dscatalog.services.ProductService;
...
public class ProductResourceTests {
	...
	private void fieldsExist(ResultActions result) throws Exception {
	...
	private void fieldsDoesNotExist(ResultActions result) throws Exception {
		...
		result.andExpect(jsonPath("$.imgUrl").doesNotExist());
